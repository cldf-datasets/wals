...
## <a name="table-genealogycsv"></a>Table [genealogy.csv](./genealogy.csv)
...
WALS' languages and language groups. WALS languages have 2 or 3 letter IDs, whereas the taxonomic units of the  Genealogical Language List have IDs prefixed with 'family-', 'subfamily-' or 'genus-'.

property | value
 --- | ---
[dc:conformsTo](http://purl.org/dc/terms/conformsTo) | [CLDF LanguageTable](http://cldf.clld.org/v1.0/terms.rdf#LanguageTable)
[dc:extent](http://purl.org/dc/terms/extent) | 3573
...
[Parent_ID](http://cldf.clld.org/v1.0/terms.rdf#languageReference) | `string` | References [languages.csv::ID](#table-languagescsv)
...
Media files associated with WALS chapters.
...
[Contribution_ID](http://cldf.clld.org/v1.0/terms.rdf#contributionReference) | `string` | References [chapters.csv::ID](#table-chapterscsv)
